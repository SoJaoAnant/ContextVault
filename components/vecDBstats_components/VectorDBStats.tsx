  ...
  const fetchStats = useCallback(async () => {
    try {
      ...
      if (
        ...
        setError('🚨 Backend is offline. Either wait for the server to start or check out the Demo page to see how it works!');
      } else {
        setError(
        ...
        <div className="flex-1 px-6 py-4">
          ...
          {stats && (
            <div className="space-y-3 text-m">
              ...
              <div className="flex items-center justify-between">
                <span className="text-gray-500">Total number of embedded chunks</span>
